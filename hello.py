...
def user(username=None):
    ...
    aa=make_response(render_template('user.html', dados=dados,chaves=chaves,username=session['username']))
...
def index():
    ...
    aa=make_response(render_template('indice.html', atime=T.time()-session["itime"]))
    return aa
